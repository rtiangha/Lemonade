...
void main() {
    ...
    void RasterFont::Draw(const Frontend::EmuWindow& window, const Layout::FramebufferLayout& layout) {
        ...
        draw_info.font_width = CHARACTER_WIDTH / draw_info.screen_width * scaled_density * 3.50f;
        draw_info.font_height = CHARACTER_HEIGHT / draw_info.screen_height * scaled_density * 3.50f;
