...
void main() {
    ...
    void RasterFont::UpdateDebugInfo() {
        ...
        std::string text = fmt::format(
                "CITRA 360 | FPS:{:>2} | VPS:{:>2} | SPD:{:>2}", static_cast<int>(stats.game_fps),
    ...
    void RasterFont::Draw(const Frontend::EmuWindow& window, const Layout::FramebufferLayout& layout) {
        ...
        draw_info.font_width = CHARACTER_WIDTH / draw_info.screen_width * scaled_density * 4.00f;
        draw_info.font_height = CHARACTER_HEIGHT / draw_info.screen_height * scaled_density * 4.00f;
