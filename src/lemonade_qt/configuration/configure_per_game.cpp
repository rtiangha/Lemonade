...
#include "lemonade_qt/configuration/configure_cheats.h"
...
#include "lemonade_qt/util/util.h"
...
void ConfigurePerGame::ResetDefaults() {
    ...
    QMessageBox::StandardButton answer = QMessageBox::question(
        this, tr("Lemonade"), tr("Are you sure you want to <b>reset your settings for this game</b>?"),
