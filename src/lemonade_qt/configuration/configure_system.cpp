...
#include "lemonade_qt/configuration/configuration_shared.h"
...
ConfigureSystem::ConfigureSystem(Core::System& system_, QWidget* parent)
    ...
    if (keys_available) {
        ...
        ui->label_nus_download->setText(
            tr("Lemonade is missing keys to download system files. <br><a "
...
void ConfigureSystem::DownloadFromNUS() {
    ...
    if (failed) {
        QMessageBox::critical(this, tr("Lemonade"), tr("Downloading system files failed."));
    } else if (!future_watcher.isCanceled()) {
        QMessageBox::information(this, tr("Lemonade"), tr("Successfully downloaded system files."));
    }
