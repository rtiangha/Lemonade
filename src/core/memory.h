 ...
 * be mapped.
 */
constexpr u32 LEMONADE_PAGE_SIZE = 0x1000;
constexpr u32 LEMONADE_PAGE_MASK = LEMONADE_PAGE_SIZE - 1;
constexpr int LEMONADE_PAGE_BITS = 12;
constexpr std::size_t PAGE_TABLE_NUM_ENTRIES = 1 << (32 - LEMONADE_PAGE_BITS);
