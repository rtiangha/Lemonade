...
public class RunningSettingDialog extends DialogFragment {
    ...
    public class SettingsItem {
        ...
        public static final int SETTING_SKIP_SLOW_DRAW = 3;
        public static final int SETTING_SKIP_CPU_WRITE = 4;
        public static final int SETTING_ACCURATE_MUL = 5;
        public static final int SETTING_AUDIO_STRECHING = 6;
        public static final int SETTING_SPEED_LIMIT = 7;
