...
public final class SettingsActivity extends AppCompatActivity implements SettingsActivityView {
    ...
    @Override
    public org.citra.emu.features.settings.model.Settings getSettings() {
        return mPresenter.getSettings();
    }

    @Override
    public void setSettings(org.citra.emu.features.settings.model.Settings settings) {
        mPresenter.setSettings(settings);
    }

    @Override
    public void onSettingsFileLoaded(org.citra.emu.features.settings.model.Settings settings) {
